...
| :--- | :--- | :--- |
| `BIRDEYE_API_KEY` | BirdEye Pro Market Data API Key | **Required** (Server-only) |
| `NEXT_PUBLIC_PRIVY_APP_ID` | Privy Application Identifier for Web3 Auth | **Required** (Client/Server) |
| `PRIVY_APP_SECRET` | Privy Private Application Secret | **Required** (Server-only) |
| `NEXT_PUBLIC_SUPABASE_URL` | URL of the Supabase backend project | **Required** (Client/Server) |
| `NEXT_PUBLIC_SUPABASE_ANON_KEY` | Supabase Public Anonymous API Key | **Required** (Client/Server) |
| `SUPABASE_SERVICE_ROLE_KEY` | Supabase Private Service Role Key for User Sync | **Required** (Server-only) |
| `NEXT_PUBLIC_ALCHEMY_RPC_URL` | Alchemy Solana Mainnet RPC Connection URL | **Required** (Client/Server) |
